...
// Theme classes
//light mode
$bodyClass = "bg-yellow-400 text-slate-100";
$cardClass = "bg-white-800 border-white-600 text-white-100";
$mutedText = "text-slate-500";
$softBg    = "bg-white-800 text-slate-100";
//dark mode
if ($theme === "dark") {
    $bodyClass = "bg-blue-800 text-slate-100";
    $cardClass = "bg-neultral-500 border-white-500";
    $mutedText = "text-mist-800";
    $softBg    = "bg-blue-700";
}
...
if ($requestMethod === "POST") {
    ...
    $_FILES['student_files'] = $name;

    // FILES: safe check first
    if (isset($_student_files) &&  $_FILES['student_file']['error'] === 0) {
...
$savedName = $_sesstion['student_name'] ?? "";
?>
            ...
            <div class="grid md:grid-cols-2 gap-4 mt-6">
                ...
                <div class="<?= $softBg; ?> border <?= ($theme === "dark" ? "border-slate-700" : "border-slate-200"); ?> rounded-xl p-4">
                    ...
                    <div class="mt-3 flex gap-2">
                        <a class="px-3 py-2 rounded-lg <?= ($theme === "dark" ? "bg-black-700" : "bg-cyan-200 text-black"); ?>" href="?theme=light">Light</a>
                        <a class="px-3 py-2 rounded-lg <?= ($theme === "dark" ? "bg-black-700" : "bg-cyan-200 text-black"); ?>" href="?theme=dark">Dark</a>
                    </div>
                </div>
