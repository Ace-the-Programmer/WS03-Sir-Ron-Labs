<?php
$names = ['Ace Cumbe', 'Bertong Adobo', '2ez Win', 'Multi dimen'];
$users = [
    ["name" => 'Ace', "email" => 'neust@gmail.com'],
    ["name" => 'Berto', "email" => 'berto@gmail.com'],
    ["name" => '2ez', "email" => '2ez@gmail.com'],
    ["name" => 'Multi', "email" => 'Multi@gmail.com'],
];
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mt-6">
            ...
            <ul class="mb-6">
                <?php foreach ($users as $key => $value) : ?>
                    <li><?= $key . ': Name: ' . $value['name'] . ', Email: ' . $value['email']; ?></li>
                <?php endforeach; ?>
            </ul>
